"""Download NBA team game logs with local caching."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download cached NBA team game logs.")
...
def main() -> None:
    ...
    print(f"Downloaded or loaded {len(frames)} seasons with {total_rows:,} team-game rows.")
