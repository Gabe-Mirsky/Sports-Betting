"""Sweep research-only NO probability and price guardrails."""
...
from strategy.no_calibration_guardrail import (  # noqa: E402
    run_no_calibration_guardrail_research,
    save_no_calibration_guardrail_outputs,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sweep calibrated NO guardrails.")
    ...
    parser.add_argument("--prefix", default="no_calibration_guardrail")
...
def main() -> None:
    ...
    save_no_calibration_guardrail_outputs(descriptive, validated, folds, summary, output_dir, prefix=args.prefix)
    print(f"NO guardrail status: {summary.get('status', 'n/a')}")
    ...
    print(f"Saved NO guardrail research to: {output_dir}")
